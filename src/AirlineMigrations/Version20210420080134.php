 ...
 */
final class Version20210420080134 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE ticket (id INT AUTO_INCREMENT NOT NULL, booking_id_id INT DEFAULT NULL, flight_id_id INT NOT NULL, seat VARCHAR(5) NOT NULL, passanger_name VARCHAR(255) NOT NULL, phone VARCHAR(55) NOT NULL, passanger_email VARCHAR(55) DEFAULT NULL, UNIQUE INDEX UNIQ_97A0ADA3EE3863E2 (booking_id_id), INDEX IDX_97A0ADA3AC1354F1 (flight_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
